...
namespace Valve.VR.InteractionSystem
{
	...
	public class Player : MonoBehaviour
	{
		...
		public GameObject PressureUpButton;
		public GameObject StopPressureButton;
		public GameObject Safetyvalve;
		...
		public void Draw2DDebug()
		{
			...
			if ( GUI.Button( new Rect( left, top, width, height ), text ) )
			{
				...
				{
					ActivateRig( rig2DFallback );
					PressureUpButton.SetActive(true);
					StopPressureButton.SetActive(true);
					Safetyvalve.SetActive(true);
		...
		//-------------------------------------------------
		public void ActivateRig( GameObject rig )
		{
